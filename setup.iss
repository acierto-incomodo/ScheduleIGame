[Setup]
AppName=Schedule I by StormGamesStudios
AppVersion=1.0.5
DefaultDirName={userappdata}\StormGamesStudios\NewGameDir\ScheduleIGame
DefaultGroupName=StormGamesStudios
OutputDir=C:\Users\melio\Documents\GitHub\ScheduleIGame\output
OutputBaseFilename=ScheduleI_Launcher_Installer
Compression=lzma
...
[Files]
Source: "C:\Users\melio\Documents\GitHub\ScheduleIGame\dist\installer_updater.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Users\melio\Documents\GitHub\ScheduleIGame\schedule1.ico"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Users\melio\Documents\GitHub\ScheduleIGame\schedule1.png"; DestDir: "{app}"; Flags: ignoreversion

[Icons]
Name: "{commonprograms}\StormGamesStudios\Schedule I"; Filename: "{app}\installer_updater.exe"; IconFilename: "{app}\schedule1.ico"; Comment: "Lanzador de Schedule I"; WorkingDir: "{app}"
Name: "{commonprograms}\StormGamesStudios\Desinstalar Schedule I"; Filename: "{uninstallexe}"; IconFilename: "{app}\schedule1.ico"; Comment: "Desinstalar Schedule I"

[Registry]
Root: HKCU; Subkey: "Software\Schedule I"; ValueType: string; ValueName: "Install_Dir"; ValueData: "{app}"

[UninstallDelete]
Type: filesandordirs; Name: "{app}"

[Run]
Filename: "{app}\installer_updater.exe"; Description: "Ejecutar Schedule I"; Flags: nowait postinstall skipifsilent
...
begin
  ...
  Exec('taskkill', '/F /IM "Schedule I.exe"', '', SW_HIDE, ewWaitUntilTerminated, ResultCode);
