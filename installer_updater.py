...
URL_LAUNCHER = "https://github.com/acierto-incomodo/ScheduleIGame/releases/latest/download/launcher_win.exe"
URL_VERSION  = "https://github.com/acierto-incomodo/ScheduleIGame/releases/latest/download/version_win_launcher.txt"
